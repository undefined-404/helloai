...
- **2026-09-01:** Planner Chat 输入优化上线（PromptEnhancer）—— 输入区一键「优化输入」，语义保护型 System Prompt（增强表达不改需求），低温度复用 Planner 模型链；文档体系 V2 重组（基线 / 差距 / Log 按职责分离，旧文档归档）
...
- **使用问题 / Bug 反馈**：优先提 [Issue]，邮箱：[456qwe-3@163.com](mailto:456qwe-3@163.com)（邮件标题请注明主题，便于分类处理）
