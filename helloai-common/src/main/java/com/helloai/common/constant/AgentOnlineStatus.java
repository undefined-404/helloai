 ...
 *
 * <ul>
 *   <li>ONLINE    — last_seen_time 与 last_active_time 都在 5 分钟内</li>
 *   <li>IDLE      — last_seen_time 在 5 分钟内，last_active_time 超过 5 分钟或为空</li>
 *   <li>OFFLINE   — last_seen_time 超过 5 分钟或为空（由 HealthCheckTask 标记）</li>
