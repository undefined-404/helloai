...
- 多模型 execute 分流基础能力已实测可用（2026-09-04：deepseek / minimax / qwen / kimi 4 模型连通性全通 + 12 条 seed 走通 score 降序调度与任务级选人约束，含超时/约束触发的熔断降级路径实证，LOG-20260904-001/003）：score 排序调度、EXECUTOR_AGENT_ID seed 指定、任务级 agentPolicy 约束均已有多 provider 真实工作负载验证
