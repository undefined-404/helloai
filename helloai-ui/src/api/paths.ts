...
export const paths = {
  ...
  agents: {
    ...
    skillOptions: (modelType: string) => `/admin/llm-providers/getSkillOptionsByModelType/${enc(modelType)}`,
  ...
  admin: {
    ...
    platformProviderSettings: (provider: string) => `/admin/platform/providers/saveSettingsByProvider/${enc(provider)}`,
    ...
    llmProviderModelDelete: (id: string | number, name: string) => `/admin/llm-providers/deleteModelByProviderIdAndName/${enc(id)}/${enc(name)}`,
    llmProviderModelToggle: (id: string | number, name: string) => `/admin/llm-providers/toggleModelByProviderIdAndName/${enc(id)}/${enc(name)}`,
    llmProviderModelSetDefault: (id: string | number, name: string) => `/admin/llm-providers/setDefaultModelByProviderIdAndName/${enc(id)}/${enc(name)}`,
