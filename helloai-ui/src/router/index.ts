...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'duty-leases', component: () => import('@/views/duty/DutyLeaseList.vue'), meta: { title: '打卡上班' } },
      // { path: 'prompts',    component: () => import('@/views/prompt/PromptList.vue'), meta: { title: 'Prompt 管理' } },  // v2.0: 移除，Agent 接入改用 onboarding 弹窗
