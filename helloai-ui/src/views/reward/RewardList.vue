  ...
  <el-card>
    <template #header>
      <div class="card-header">
        <span><el-icon><Coin /></el-icon> 积分流水</span>
    ...
    <el-table :data="list" border stripe v-loading="loading" style="width:100%">
      ...
      <el-table-column label="变动" width="80">
        <template #default="{ row }">
          <span :style="{ color: row.delta > 0 ? '#67c23a' : '#f56c6c', fontWeight:'bold' }">
    ...
    <el-dialog v-model="showAdjust" title="手动调整积分" width="450px" top="10vh">
