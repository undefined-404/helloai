  ...
  <div class="page ha-entrance-up">
    <el-card>
      ...
      <div class="filter-bar">
        ...
        >
          <el-option
            v-for="[k,v] in Object.entries(PROMPT_CATEGORY_MAP)"
            :key="k"
            :label="v"
            :value="k"
          />
        ...
        >
          <template #default="{ row }">
            <el-tag
              ...
              type="info"
            >
              {{ PROMPT_CATEGORY_MAP[row.category] || row.category }}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template #default="{ row }">
            <div class="action-cell">
              ...
              <el-button
                size="small"
                @click="previewCompose(row)"
              >
                组合
              </el-button>
              <el-button
                v-if="row.category==='SKILL'"
                size="small"
                type="warning"
    ...
    >
      ...
      >
        <el-row :gutter="16">
          ...
          <el-col :span="12">
            ...
            >
              ...
              >
                <el-option
                  v-for="r in ['PLANNER','EXECUTOR','REVIEWER']"
                  :key="r"
                  :label="r"
                  :value="r"
                />
          ...
          <el-col :span="12">
            <el-form-item label="Slug">
              <el-input
                ...
                placeholder="AGENT_SPECIALIZATION 时必填"
              />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="16">
          ...
          <el-col :span="8">
            <el-form-item label="示例模板">
              <el-switch
                v-model="editForm.isExample"
                :active-value="1"
                :inactive-value="0"
              />
            </el-form-item>
    ...
    >
      <el-input
        v-model="composeResult"
        type="textarea"
        :rows="20"
        readonly
      />
      <template #footer>
        <el-button @click="composeDialog=false">
          关闭
        </el-button><el-button
          type="primary"
          @click="copyCompose"
    ...
    >
      ...
      />
      <template #footer>
        <el-button @click="skillDialog=false">
          关闭
        </el-button>
      </template>
    </el-dialog>
